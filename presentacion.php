    ...
    <div class="ia-workspace">
        <?php include("navbar.php"); ?>
          <div class="presentacion">
            <div class="presentacion_rapper">
              <iframe src="https://liveceti-my.sharepoint.com/personal/a17310214_live_ceti_mx/_layouts/15/Doc.aspx?sourcedoc={8c952002-5d58-4a3c-b40b-b10b87e3c313}&amp;action=embedview&amp;wdAr=1.7777777777777777" width="1186px" height="691px" frameborder="0">Esto es un documento de <a target="_blank" href="https://office.com">Microsoft Office</a> incrustado con tecnología de <a target="_blank" href="https://office.com/webapps">Office Online</a>.</iframe>
              <a href="presentacion.pptx" download="presentacion.pptx">PRESENTACION MEDIA QUERIES</a>

              <a href="proyecto.pptx" download="proyecto.pptx">PRESENTACION PROYECTO</a>
            </div>
          </div>
